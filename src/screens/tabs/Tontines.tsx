...
export function Tontines() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'COMPLETED': return <span className="bg-[#E8F5E9] text-[#064E3B] px-2 py-1 rounded text-[10px] font-bold">TERMINÉ</span>;
  ...
  return (
    <div className="flex-1 bg-[#F5F0E8] flex flex-col h-full">
      <div className="bg-white px-6 pt-12 pb-4 shadow-sm z-10">
        <h1 className="text-[#141414] text-2xl font-bold mb-4">Mes Tontines</h1>
        ...
        <div className="flex bg-[#E8E0D0] p-1 rounded-xl">
          <button
            ...
            className={cn(
              ...
              activeTab === 'cercle' ? "bg-white text-[#064E3B] shadow-sm" : "text-[#7C6F5E]"
            )}
          >
            Cercles (Privé)
          </button>
          <button
            ...
            className={cn(
              "flex-1 py-2 rounded-lg text-sm font-semibold transition-all",
              activeTab === 'pool' ? "bg-white text-[#064E3B] shadow-sm" : "text-[#7C6F5E]"
            )}
          >
            Afiya Pools
          </button>
        ...
        {activeTab === 'cercle' ? (
          <div className="space-y-4">
            <div className="flex gap-3 mb-6">
              <button 
                ...
                className="flex-1 bg-[#064E3B] text-white p-4 rounded-2xl flex flex-col items-center justify-center gap-2 active:bg-[#047857] transition-colors"
              >
                <Plus size={24} />
              ...
              <button 
                ...
                className="flex-1 bg-white border-2 border-[#E8E0D0] text-[#064E3B] p-4 rounded-2xl flex flex-col items-center justify-center gap-2 active:bg-[#F5F0E8] transition-colors"
              >
                <Users size={24} />
            ...
            <h2 className="text-[#141414] font-semibold text-lg mb-2">Mes Cercles Actifs</h2>
            ...
            {loading ? (
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E8E0D0] text-center">
                ...
                <h3 className="text-[#141414] font-bold mb-2">Aucun cercle</h3>
                ...
                {groups.map((group) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-6">
                      <div>
                        <h3 className="text-[#141414] font-bold text-lg mb-1">{group.name}</h3>
                    ...
                    <div className="flex justify-between items-end">
                      <div>
                        ...
                        <p className="text-[#141414] font-bold">{formatXOF(group.contribution_amount)} <span className="text-[#7C6F5E] text-xs font-normal">/ {group.frequency === 'WEEKLY' ? 'semaine' : group.frequency === 'MONTHLY' ? 'mois' : 'trimestre'}</span></p>
                      </div>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-10">
            <div className="w-16 h-16 bg-[#E8E0D0] rounded-full flex items-center justify-center mb-4">
              <Shield size={32} className="text-[#064E3B]" />
            </div>
            <h3 className="text-[#141414] font-bold text-lg mb-2">Afiya Pools</h3>
